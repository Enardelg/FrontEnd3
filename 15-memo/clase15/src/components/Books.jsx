...
const books = [
    ...
    {
        "id": 9,
        "nombre": "Sombras por silencio en los bosques del infierno",
    ...
    {
        "id": 15,
        "nombre": "Sexto del ocaso",
        "saga": "Arcanum Unbounded",
        "planeta": "Primero del sol",
        "año": 2016,
        "paginas": 128
    }
]
...
function Books() {
    ...
    const filtrarLibros = useMemo(() => {
        console.log("filtrando libros", setSelectedTag );
